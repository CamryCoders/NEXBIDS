...
import { useNavigate } from 'react-router'
 ...
 function BidComponent({title,duration,BidId,highest_bid,thumbnail}){
  ...
  <div class="flex flex-col sm:flex-row gap-6 items-center">
    ...
    <div class="w-full sm:w-3/5 flex flex-col justify-between self-stretch space-y-4 pt-1 sm:pt-0">
      ...
      <div class="flex flex-col sm:flex-row items-center gap-3 pt-1">
        ...
        <button
        onClick={getBidPage}
        class="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-cyan-500 via-indigo-500 to-purple-600 bg-[size:150%_auto] hover:bg-right text-white font-bold text-sm rounded-xl shadow-md shadow-indigo-100 hover:shadow-lg hover:shadow-indigo-200/50 transform active:scale-[0.98] transition-all duration-300 shrink-0 flex items-center justify-center gap-2">
